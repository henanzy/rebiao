	...
	<div id="increasedis" class="clearfix" style="overflow: hidden;height:1000px;">
		...
		<div class="mws-panel grid_8 "
			...
			<p>
					...
					<input id="operation_one_btn" type="submit" value="查询区管状态" />
					<input id="operation_one_btn" type="submit" value="实时热表数据" />
					<input id="operation_all_btn" type="submit" value="查询热表地址" />
					旧地址：<input type="text" size="5px" >
					新地址：<input type="text" size="5px" >
					<input id="increase_btn" type="submit" value="添加热表地址" />
					<input id="increase_btn" type="submit" value="删除热表地址" />
