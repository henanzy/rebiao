	...
	<div id="increasedis" class="clearfix" style="overflow: hidden;">
		...
		<div id="change_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 900px;">
